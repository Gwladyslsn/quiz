...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        if (pseudoExists($pdo, $pseudo_user)) {
            echo '
        <div class="alert alert-success">
            <p class="text-white bg-gray-900 body-font">Désolé, un compte avec ce pseudo existe déjà. Veuillez utiliser un autre pseudo.</p>
        </div>
        ';
        } else {
            //Verifier si email exist dans bdd
            if (emailExists($pdo, $mail_user)) {
                echo '
        <div class="alert alert-success">
        ...
        ';
            ...
            //Verifier si inscription réussie
                ...
                if (addUser($pdo, $pseudo_user, $mail_user, $mdp_user)) {
                    echo '
            <div class="alert alert-success">
                <p class="text-gray-400 bg-gray-900 body-font">✅ Inscription réussie ! Vous pouvez maintenant vous <a href="connexion.php" class="text-white">connecter ici.</a></p>
            </div>
            ';
                } else {
...
<body>
    ...
    <section class="text-gray-400 bg-gray-900 body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap items-center ">
            ...
            <form action="" method="post" class="lg:w-2/6 md:w-1/2 bg-gray-800  bg-opacity-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0" id="inscriptionForm">
                ...
                <button type="button" id="btnSign" class="text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg mt-3">S'inscrire</button>
...
<?php
$page_script = './asset/js/inscription.js';
